const products = [
    ...
    { name: 'GSM 800L', price: 110.99, image: 'https://i.ibb.co/HqG2HfM/download-1.jpg', description: 'GSM 800L module is used for interfacing with mobile networks for sending and receiving messages.', stock: 9 },
    ...
    { name: 'Raspberry Pi', price: 250.99, image: 'https://i.ibb.co/NSj3ytK/shopping.webp', description: 'Raspberry Pi is a series of small single-board computers developed to promote the teaching of basic computer science.', stock: 18 },
    { name: 'Breadboard', price: 14.99, image: 'https://i.ibb.co/k0qtXV7/download-2.webp', description: 'A breadboard is a construction base for prototyping of electronics.', stock: 25 },
    { name: 'Jumper Wires', price: 15.99, image: 'https://i.ibb.co/4F6T5XW/download-3.webp', description: 'Jumper wires are used to make connections between the components on a breadboard or other prototype.', stock: 30 },
    { name: 'LCD Display', price: 40.99, image: 'https://i.ibb.co/zQFBgDs/download-5.webp', description: 'An LCD display is a flat-panel display that uses the light-modulating properties of liquid crystals.', stock: 17 },
    { name: 'Temperature Sensor', price: 35.99, image: 'https://i.ibb.co/JrVSxmX/download-4.webp', description: 'A temperature sensor is a device that collects data about temperature from a source and converts it to a form that a device can understand.', stock: 14 },
    { name: 'Ultrasonic Sensor', price: 40.99, image: 'https://i.ibb.co/86mb78S/download-3.jpg', description: 'An ultrasonic sensor is a device that can measure the distance to an object by using sound waves.', stock: 11 },
    { name: 'LED', price: 1.50, image: 'https://i.ibb.co/c3NrrjG/shopping-1.webp', description: 'A light-emitting diode (LED) is a semiconductor light source that emits light when current flows through it.', stock: 50 },
    { name: 'Servo Motor', price: 55.99, image: 'https://i.ibb.co/N2nQBtZ/download-2.jpg', description: 'A servo motor is a rotary actuator that allows for precise control of angular position.', stock: 7 },
    { name: 'Resistors', price: 3.99, image: 'https://i.ibb.co/GTrH2Gq/download-4.jpg', description: 'A resistor is a passive electrical component with the primary function to limit the flow of electric current.', stock: 100 },
    { name: 'Capacitors', price: 2.99, image: 'https://i.ibb.co/QPKLWcn/images.jpg', description: 'A capacitor is a device that stores electrical energy in an electric field.', stock: 80 },
    { name: 'Transistors', price: 9.99, image: 'https://i.ibb.co/1ZVPGJH/images-1.jpg', description: 'A transistor is a semiconductor device used to amplify or switch electronic signals and electrical power.', stock: 75 },
    { name: 'Diodes', price: 4.99, image: 'https://i.ibb.co/DWc58rG/download-5.jpg', description: 'A diode is a semiconductor device that allows current to flow in one direction only.', stock: 60 },
    { name: 'Inductors', price: 7.99, image: 'https://i.ibb.co/j3BqMNK/download.png', description: 'An inductor is a passive electronic component that stores energy in the form of a magnetic field.', stock: 40 },
